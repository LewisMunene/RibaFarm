...
import CountySelector from "@/components/auth/CountySelector";
...
export default function RegisterPage() {
  ...
  // Handle county and sub-county changes from CountySelector
  const handleCountyChange = (county: string) => {
    setFormData(prev => ({...prev, county}));
    // Clear county error when user selects
    if (errors.county) {
            ...
            <div className="bg-white/90 backdrop-blur-md rounded-2xl p-8 border border-gray-200 shadow-xl">
              ...
              {currentStep === 2 && (
                <div className="space-y-6">
                  ...
                  {/* Location Fields - Using Our New CountySelector Component! */}
                  <CountySelector
                  ...
                  <div className="space-y-3">
                    ...
                    <label className="flex items-start gap-3 cursor-pointer">
                      ...
                      />
                      <span className="text-sm text-gray-700">
                        Send me farming tips, market updates, and platform news (recommended)
                      </span>
                    </label>
                  </div>
